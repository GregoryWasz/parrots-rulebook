...
\begin{enumerate}
  ...
  \item Organizatorzy rekomendują uczesniczenie w treningach oraz sparingach w kaskach hokejowych wyposażonych w kratę, oraz ochraniaczach na szyję.
  \item W przypadku uczestników niepełnoletnich kask wyposażony w kratę oraz ochraniacz na szyję są bezwzględnie wymagane.
\end{enumerate}
...
\begin{tabular}{ |c|c|c| } 
 \hline
 Miesiąc & Ilość piątków w miesiącu & Przewidywana kwota składki (zł) \\ 
 \hline
 Wrzesień 2025 & 4 & 200 \\ 
